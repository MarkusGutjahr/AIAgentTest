...
get_seo_page_report:
e.g. get_seo_page_report: x.com
Returns a full seo report for the web page

Example session:

Question: is the heading optimized for the keyword 'marketing' in this web page: x.com?
...
//$react_system_prompt = trim($testPrompt);
$react_system_prompt = "test";
